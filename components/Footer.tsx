      ...
      <div className="container-app grid grid-cols-2 gap-8 py-12 md:grid-cols-5">
        <div className="col-span-2">
          ...
          <p className="mt-3 max-w-xs text-sm text-white/55">
            India&apos;s decoration marketplace — shop balloon arches, room
            setups, romantic decor and event packages, then book a local team to
            set it all up.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link href="/custom-decoration" className="hover:text-white">
                Custom Decoration
              </Link>
            </li>
            <li>
              <Link href="/inspiration" className="hover:text-white">
                Inspiration
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <div className="mt-4 space-y-1.5 text-sm text-white/60">
            ...
            <p className="flex items-center gap-2">
              <Mail size={13} /> hello@presoudreamevents.in
            </p>
          </div>
        </div>
      </div>
