...
export function buildNavigationConfig(
  ...
  return [
        ...
        [
          {
            title: "Shop by Theme",
            links: filterLinks([
              createLink("Rose Gold", {
                occasion: "Birthday",
                theme: "Rose Gold",
              }),
              createLink("Pastel", { occasion: "Birthday", theme: "Pastel" }),
              createLink("Jungle Safari", {
                occasion: "Birthday",
                theme: "Jungle Safari",
              }),
              createLink("Superhero", {
                occasion: "Birthday",
                theme: "Superhero",
              }),
              createLink("Princess", {
        ...
        [
          {
            title: "Party Setups",
            links: filterLinks([
              createLink("Balloon Decorations", {
                occasion: "Birthday",
                decorationType: "Balloon",
              }),
              createLink("Room Decorations", {
                occasion: "Birthday",
                decorationType: "Room Decoration",
              }),
              createLink("Canopy Decorations", {
                occasion: "Birthday",
                decorationType: "Canopy",
              }),
              createLink("Stage / Backdrop", {
                occasion: "Birthday",
                style: "Backdrop",
              }),
              createLink("Premium Setups", {
                occasion: "Birthday",
                isPremium: true,
              }),
            ]),
        ...
        [
          {
            title: "Popular Picks",
            links: filterLinks([
              createLink("Best Sellers", {
                occasion: "Birthday",
                isBestSeller: true,
              }),
              createLink("Under ₹999", { occasion: "Birthday", maxPrice: 999 }),
              createLink("Under ₹1,999", {
                occasion: "Birthday",
                maxPrice: 1999,
              }),
              createLink("New Arrivals", {
                occasion: "Birthday",
                isNewArrival: true,
              }),
            ]),
        ...
        [
          {
            ...
            links: filterLinks([
              ...
              createLink("Birthday Balloons", {
                occasion: "Birthday",
                decorationType: "Balloon",
              }),
              createLink("Anniversary Balloons", {
                occasion: "Anniversary",
                decorationType: "Balloon",
              }),
              createLink("Baby Shower Balloons", {
                occasion: "Baby Shower",
                decorationType: "Balloon",
              }),
              createLink("Kids Balloons", {
                occasion: "Kids",
                decorationType: "Balloon",
              }),
              createLink("Romantic Balloons", {
                occasion: "Romantic",
                decorationType: "Balloon",
              }),
              createLink("Wedding Balloons", {
                occasion: "Wedding",
                decorationType: "Balloon",
              }),
            ]),
        ...
        [
          {
            title: "By Setup",
            links: filterLinks([
              createLink("Balloon Arch", {
                decorationType: "Balloon",
                style: "Balloon Arch",
              }),
              createLink("Balloon Backdrop", {
                decorationType: "Balloon",
                style: "Backdrop",
              }),
              createLink("Ceiling Decor", {
                decorationType: "Balloon",
                style: "Ceiling",
              }),
              createLink("Balloon Bouquet", {
                decorationType: "Balloon",
                style: "Bouquet",
              }),
              createLink("Room Balloon Decor", {
                decorationType: "Room Decoration",
              }),
              createLink("Premium Balloon", {
                decorationType: "Balloon",
                isPremium: true,
              }),
            ]),
        ...
        [
          {
            ...
            links: filterLinks([
              ...
              createLink("Romantic Anniversary", {
                occasion: "Anniversary",
                audience: "Romantic",
              }),
            ]),
        ...
        [
          {
            ...
            links: filterLinks([
              ...
              createLink("Baby Girl", {
                occasion: "Baby Shower",
                audience: "Girl",
              }),
              createLink("Baby Welcome", {
                occasion: "Baby Shower",
                audience: "Welcome",
              }),
              createLink("Baby Shower Themes", {
                occasion: "Baby Shower",
                theme: "Pastel",
              }),
            ]),
        ...
        [
          {
            ...
            links: filterLinks([
              ...
              createLink("Bridal Welcome", {
                occasion: "Wedding",
                audience: "Bridal Welcome",
              }),
              createLink("Wedding Car", {
                occasion: "Wedding",
                decorationType: "Wedding Car",
              }),
              createLink("First Night", {
                occasion: "Wedding",
                audience: "First Night",
              }),
              createLink("Bachelorette", {
                occasion: "Wedding",
        ...
        [
          {
            title: "Setups",
            links: filterLinks([
              createLink("Stage Decorations", {
                occasion: "Wedding",
                decorationType: "Stage",
              }),
              createLink("Canopy", {
                occasion: "Wedding",
                decorationType: "Canopy",
    ...
    },
    {
      id: "cities",
      label: "Cities",
      slug: dbCities.length > 0 ? dbCities[0].slug : "mumbai",
      columns: [
        [
          {
